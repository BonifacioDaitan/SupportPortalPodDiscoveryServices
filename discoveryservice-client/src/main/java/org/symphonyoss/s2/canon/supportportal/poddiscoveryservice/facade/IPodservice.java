...
import org.symphonyoss.s2.canon.supportportal.poddiscoveryservice.canon.IPodserviceModel;

public interface IPodservice extends IPodserviceModel
{
  Collection<Pod> getAllPods();
}
/*----------------------------------------------------------------------------------------------------
