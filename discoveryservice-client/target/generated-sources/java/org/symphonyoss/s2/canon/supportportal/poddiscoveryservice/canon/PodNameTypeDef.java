...
import org.symphonyoss.s2.canon.runtime.StringTypeDefBuilder;
 ...
 */
@Immutable
public class PodNameTypeDef extends TypeDef implements IStringProvider, Comparable<PodNameTypeDef>
{
  private @Nonnull String value_;

  protected PodNameTypeDef(@Nonnull String value) throws BadFormatException
  {
    if(value == null)
  ...
  protected PodNameTypeDef(@Nonnull IJsonDomNode node) throws BadFormatException
  {
    if(node == null)
      throw new BadFormatException("value is required.");
  ...
  {
    if(obj instanceof PodNameTypeDef)
    {
      return value_.equals(((PodNameTypeDef)obj).value_);
    }
  ...
  @Override
  public int compareTo(PodNameTypeDef other)
  {
    return value_.compareTo(other.value_);
  }
  
  public static abstract class Builder extends StringTypeDefBuilder<PodName>
  {
  }
}
