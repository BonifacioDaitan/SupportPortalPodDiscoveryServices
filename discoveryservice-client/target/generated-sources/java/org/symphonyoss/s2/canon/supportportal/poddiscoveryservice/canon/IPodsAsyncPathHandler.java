 ...
 *    Template name        template/java/Path/I_AsyncPathHandler.java.ftl
 ...
 * Bind Path			pods
 */
public interface IPodsAsyncPathHandler extends IPodserviceEntityHandler
{
  /**
   * get /pods
   * No summary given.
  ...
  * @param _consumer A consumer into which responses may be passed.
   ...
   */
  void handleGet(
    @Nonnull  IConsumer<PodPage>        _consumer,
...
/*----------------------------------------------------------------------------------------------------
 * End of template template/java/Path/I_AsyncPathHandler.java.ftl
